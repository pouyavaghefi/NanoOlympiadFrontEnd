...
@if(($findToken))
    <div class="list-group m-2 ">
        ...
        <a href="{{ route('cla.logout') }}" class="list-group-item list-group-item-action border-0 ">
            <i class="icofont-logout fs-6 me-3"></i>Signout
        </a>
    </div>
@else
    <div class="list-group m-2 ">
        <a href="{{ env('URL_PANEL') }}" class="list-group-item list-group-item-action border-0 ">
            <i class="icofont-graduate-alt fs-6 me-3"></i>User Dashboard
        </a>
        <div><hr class="dropdown-divider border-dark"></div>
        <a href="{{ route('cla.logout') }}" class="list-group-item list-group-item-action border-0 ">
