<div class="col-xxl-2 col-xl-2 col-lg-12 col-md-12 order-2 order-sm-2 order-md-2 order-lg-1">
    <div class="sidebar mx-0 video-menu px-4 py-4 order-1">
        <div class="d-flex flex-xl-column flex-xxl-column h-100">
                    ...
                    @forelse($episodes as $episode)
                        @php
                            ...
                            $episodeRouteToPlay = $isFirstEpisode
                                ? route('frt.crs.course_player.index', ['slug' => $course->slug])
                                : route('frt.crs.course_player.index.rest', ['slug' => $course->slug, 'epi' => $episode->slug]);
            ...
            <a href="/courses/all" title="Go Back to Home" class="btn btn-link sidebar-mini-btn text-light">
                <span class="ms-2">
