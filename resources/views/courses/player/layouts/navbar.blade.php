    ...
    <div class="container-fluid">
        ...
        <div class="video-nav-group">
            @if($play_prev_option && $lastOne)
                <a href="{{ route('frt.crs.course_player.index.rest',['slug'=>$course->slug,'epi'=>$lastOne]) }}"
            ...
            <a href="/courses/book-lets"
               class="video-nav-link" title="Booklets">
                <i class="icofont-file-text"></i>
            </a>

            @if($nextSlug)
                <a href="{{ route('frt.crs.course_player.index.rest',['slug'=>$course->slug,'epi'=>$nextSlug]) }}"
        ...
        <div class="order-0 col-lg-4 col-md-4 col-sm-12 col-12 mb-3 mb-md-0">
            <div class="input-group flex-nowrap input-group-lg">
                <a href="{{ route('frt.crs.course_player.index', $course->slug) }}">
                    <h3 class="curved-underline" style="color:white">NANOTECHNOLOGY COURSES</h3>
                </a>
