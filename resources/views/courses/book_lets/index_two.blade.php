    ...
    <div class="about-area mt-4">
        <div id="pdf-container" class="pdf-viewer-container">
            ...
            <div class="download-buttons mt-4 d-flex justify-content-center gap-4">
                <a href="https://ino-official.org/dl/booklet-2.pdf" download class="download-btn" target="_blank" rel="noopener noreferrer">
            ...
            <div class="d-flex justify-content-center mt-3">
                <a href="https://ino-official.org/dl/booklet-2.pdf" id="sharePdfLink" class="btn btn-outline-primary" target="_blank" rel="noopener noreferrer">
                    Share PDF Link
                </a>
...
@section('scripts')
    <script>
        const url = 'https://ino-official.org/dl/booklet-2.pdf';
        ...
        function saveToGoogleDrive() {
            ...
            const tokenClient = google.accounts.oauth2.initTokenClient({
                ...
                callback: async (tokenResponse) => {
                    ...
                    const fileUrl = 'https://nanolympiad.org/dl/booklet-2.pdf';
                    const fileName = 'booklet-2.pdf';
